$(document).ready(function () {
    ...
    const botImages = ["/upocargo/static/src/img/rock.png", "/upocargo/static/src/img/paper.png", "/upocargo/static/src/img/scissors.png"];
    const outcomes = {
        RR: "Draw",
        RP: "BOT",
        RS: "YOU",
    ...
    function handleOptionClick(event) {
        ...
        userResult.src = botResult.src = "/upocargo/static/src/img/rock.png";
