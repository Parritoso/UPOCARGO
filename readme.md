...
El sector de mudanzas y almacenamiento enfrenta desafíos significativos en cuanto a la digitalización y la optimización de recursos. UPOCARGO se plantea como una solución integral que permite gestionar tanto las operaciones de mudanza como el almacenamiento de bienes de manera eficiente y centralizada.
A través de este proyecto académico, se busca diseñar un sistema que mejore los procesos internos de una empresa de mudanzas y guardamuebles, permitiendo una gestión más controlada y automatizada de las solicitudes, inventarios, y la relación con los clientes. Este sistema proporcionará a la empresa herramientas digitales avanzadas para coordinar y optimizar el uso de recursos, desde la asignación de empleados y vehículos, hasta la administración de contratos y tiempos de entrega.
Este proyecto no se limitará a optimizar procesos internos, sino que se plantea como una plataforma **omnicanal** capaz de integrar todas las operaciones bajo un único sistema eficiente, al mismo tiempo que ofrece un **portal interactivo para los clientes**. Los usuarios podrán gestionar sus solicitudes de mudanza, realizar inventarios de bienes almacenados, coordinar fechas de servicios y monitorear el progreso de sus mudanzas en tiempo real.
...
### 1.3 Oportunidad de Innovación Tecnológica:
